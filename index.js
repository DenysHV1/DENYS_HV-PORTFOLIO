import{h as w}from"./assets/header-DMm7itIw.js";import{p as m}from"./assets/project-arr-BVZtUL2A.js";import{S as g}from"./assets/vendor-BiMJRTlQ.js";function b(t,i){function o(s){const r=[];for(let e=s.length-1;e>=0;e--)r.push(s[e]);const l=r.length;return r.map(({name:e,id:a,status:n,imgPreview:c,codeLink:p,siteLink:d,technology1:u,technology2:f,technology3:h})=>{if(n&&a>l-10)return`
