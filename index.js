import{h}from"./assets/header-B4c5GArV.js";import{p as w}from"./assets/project-arr-DPN6WERs.js";import{S as m}from"./assets/vendor-BiMJRTlQ.js";function g(t,i){function o(s){const r=[];for(let e=s.length-1;e>=0;e--)r.push(s[e]);const l=r.length;return r.map(({name:e,id:a,status:n,imgPreview:c,codeLink:p,siteLink:d,technology1:u,technology2:f})=>{if(n&&a>l-10)return`
