import{h as I,s as w}from"./assets/header-DxQOKGJQ.js";import{p as C}from"./assets/project-arr-B73VjAXQ.js";import{S as q}from"./assets/vendor-BiMJRTlQ.js";//!!! Работает только если на одной страничке одна форма
...
</li>`}).join("");i.insertAdjacentHTML("beforeend",u(c,a)),t.addEventListener("click",()=>{if(a===3)t.textContent="Hide",a=s,i.innerHTML="",i.insertAdjacentHTML("beforeend",u(c,a));else{t.textContent="Show more",a=3,i.innerHTML="",i.insertAdjacentHTML("beforeend",u(c,a));const f=i.querySelector(".favorite-item");if(f){const x=f.offsetTop-200;scrollTo(i,x,500)}}})};I();const K=document.querySelector(".swiper-wrapper");J(C,K);M();j(C);A(C);w();
